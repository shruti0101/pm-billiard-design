...
<section className="w-full bg-white mx-auto py-12 md:py-20  space-y-16 md:space-y-20 overflow-x-hidden">
...
<div className="rounded-3xl overflow-hidden border border-gray-200 bg-[#f7f7f7] shadow-2xl">
...
<span className="text-black uppercase text-base">{spec.label}</span>
<span className="text-black text-right text-lg font-medium">{spec.value}</span>
</div>
))}
...
<p className="mt-4 text-sm text-[#1a1a1a] max-w-xs">{item.desc}</p>
</motion.div>
))}
</div>
