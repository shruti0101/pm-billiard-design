...
const DEFAULT_PARTICLE_COUNT = 62;
const DEFAULT_SPOTLIGHT_RADIUS = 400;
const DEFAULT_GLOW_COLOR = '132, 0, 35';
...
const cardData = [
  {
    ...
    title: 'Pool Tables',
    description:
      'Designed for precision play with professional slate beds, tournament-grade cloth, and hand-finished hardwood frames.',
    label: 'Master Series'
  },
  {
    color: '#060010',
    ...
    description:
      'Built to international tournament standards with premium slate, championship cloth, and reinforced wooden frames.',
    label: 'Championship Grade'
  },
 {
  color: '#060010',
...

{
...

  {
    ...
    title: 'Accessories',
    description:
      'Premium cues, balls, lighting, and table accessories to complete the perfect playing setup.',
    label: 'Essentials'
  },
  {
    color: '#060010',
    ...
    description:
      'Expert installation, leveling, and long-term servicing to ensure flawless performance.',
              ...
              return (
                <ParticleCard
                  ...
                  <div className="card__header flex justify-between gap-3 relative text-white">
                    <span className="card__label text-base text-yellow-500">{card.label}</span>
                  </div>
             <div className="card__content flex flex-col   gap-3 relative text-white">

                    <h3
                      className={`card__title font-normal text-4xl mt-2 mb-4 ${textAutoHide ? 'text-clamp-1' : ''}`}>
                      {card.title}
                    </h3>
                    <p
                      className={`card__description text-[18px]  o ${textAutoHide ? 'text-clamp-2' : ''}`}>
                      {card.description}
                    </p>
