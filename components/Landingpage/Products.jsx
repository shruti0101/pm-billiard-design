...
export default function PremiumProductSlider() {
  return (
    <section className="bg-[#f9f8f5] relative py-12 sm:py-16 lg:py-18 px-4 sm:px-6 overflow-hidden">
      {" "}
      ...
      <Swiper
        ...
        breakpoints={{
          0: {
            slidesPerView: 1.1,
            spaceBetween: 12,
            coverflowEffect: { depth: 60 },
          },
          480: {
            slidesPerView: 1.3,
            spaceBetween: 16,
            coverflowEffect: { depth: 70 },
          },
          640: {
            slidesPerView: 1.4,
            spaceBetween: 20,
            coverflowEffect: { depth: 90 },
          },
          768: {
            slidesPerView: 2,
            spaceBetween: 28,
